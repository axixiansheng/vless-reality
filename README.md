...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/axixiansheng/vless-reality/main/reality.sh)
```

非交互安装（NAT 机请把 PORT 改成你已映射的外网端口）：

```bash
PORT=30810 DEST=www.apple.com bash <(curl -fsSL https://raw.githubusercontent.com/axixiansheng/vless-reality/main/reality.sh) install
```

查看已部署节点信息：

```bash
bash <(curl -fsSL https://raw.githubusercontent.com/axixiansheng/vless-reality/main/reality.sh) info
```
